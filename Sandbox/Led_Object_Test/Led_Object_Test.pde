...
{
  // size (300, 300, P3D);
  size (screen.width, screen.height, OPENGL); // Create canvas , must be first in setup function
  ...
  whiteBox1 = new GuiButton(screen.width/2 + 40,       screen.height*.6180399 - 44 -25, 65, 40, white); // new Gui button with golden ratio
  blackBox1 = new GuiButton(screen.width/2 + 40 + 80,  screen.height*.6180399 - 44 -25, 65, 40, black); // new Gui button with golden ratio
  redBox1   = new GuiButton(screen.width/2 + 40 + 160, screen.height*.6180399 - 44 -25, 65, 40, red); // new Gui button with golden ratio
  blueBox1  = new GuiButton(screen.width/2 + 40 + 240, screen.height*.6180399 - 44 -25, 65, 40, blue); // new Gui button with golden ratio
  greenBox1 = new GuiButton(screen.width/2 + 40 + 320, screen.height*.6180399 - 44 -25, 65, 40, green); // new Gui button with golden ratio

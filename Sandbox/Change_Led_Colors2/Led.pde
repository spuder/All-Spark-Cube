...
class Led {
  ...
  Led()
  {
    ...
    //don't create default object because you don't want default objects to be displayed
    /*
  ...
  // Array of Strings Constructor
//  Led(String[] loadedFile)
//  {
//    //loadedFile is the name of the variable that the main program saves from the selectFile method
//    
//    
//  }
...
=========================================================================================*/
  ...
  int getLedLocationX()
  {
     return this.ledLocationX; 
  }
  
  int getLedLocaitonY()
  {
      return this.ledLocationY;
  }
  ...
  void display() // Actually send the object to the screen, implemented as method of object to allow for refreshing
  {
    ...
    fill(this.ledColor); println(this.ledColor);

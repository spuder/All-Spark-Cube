...
class RowObject
{
  ...
  RowObject(int rowCoordinateY, int rowCoordinateZ)
  {
    ...
    int firstLedInRow = relativeLedLocationToAbsolute(rowCoordinateY, rowCoordinateZ);  debug("firstledInrow " + firstLedInRow);

    debug("Y : " + rowCoordinateY +" Z : " + rowCoordinateZ + " is led " + firstLedInRow);
...
//  
        ...
        // debug("created led object " + aLedObject.getLedNumberInCube() + " With row index of " + aLedObject.getLedNumberInRow() );
        
        this.anAraryOfRowLeds[aLedObject16.getLedNumberInCube() ] = aLedObject16;    

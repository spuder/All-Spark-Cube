...
//  RowController(int yNumberOfRowsPerPanel, int zNumberOfPanels ) // in all my tests this will be 16
//  {
...
//     for (int yRowIterator = 0; yRowIterator < yNumberOfRowsPerPanel; yRowIterator ++ )
//       {
...
//    
//    int rectangleTopLeftCornerX = height - yNumberOfRowsPerPanel - 20;
//    int rectangleTopLeftCornerY = 10;
//    int rectangleWidth = xNumberOfLedsPerRow * 10  ;
